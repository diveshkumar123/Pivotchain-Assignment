		...
		return (
			...
			<section>
				...
				<div className="carouselWrapper col-lg-12">
					...
					<div class="container1 col-lg-5 col-lg-offset-2 col-md-6 ">
					...
					<div class="playButtonBox hidden-xs ">
						<i className="fa fa-play playIcon"></i>
					</div>


					<div class="container2 col-lg-3 col-md-6">
						    ...
						    <div class="carousel-inner">
						      <div class="item active">
						       ...
						       <i className="fa fa-circle dotIcon1"></i>
						        ...
						        <div className="subOne1">Raven Works Seamlessly With <br/> your existing CCTV Cameras.</div>
